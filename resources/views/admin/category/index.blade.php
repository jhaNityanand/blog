...
@section('css')
@php config(['app.name' => 'Blog | Category']); @endphp
<!-- SweetAlert -->
                    ...
                    <table id="datatabless" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <b>
                                        <a data-toggle="tooltip" data-placement="top" title="View Record" href="{{ route('category.show', $value->id) }}" target="_blank" class="btn btn-outline-warning">
                                            <i class='fas fa-eye'></i>
                                        </a>
                                    </b>
                                    <b>
                                        <a data-toggle="tooltip" data-placement="top" title="Edit Record" href="{{ route('category.edit', $value->id) }}" class="btn btn-outline-info">
                                    ...
                                    <b>
                                        ...
                                        <form id="delete-form-{{ $key + 1 }}" action="{{ route('category.destroy', $value->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </b>
