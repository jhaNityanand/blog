...
@section('css')
@php config(['app.name' => 'Blog | Question']); @endphp
<!-- SweetAlert -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title"> View all questions </h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <table id="datatabless" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <b>
                                        <a data-toggle="tooltip" data-placement="top" title="View Record" href="{{ route('questions.show', $value->id) }}" target="_blank" class="btn btn-outline-warning">
                                            <i class='fas fa-eye'></i>
                                        </a>
                                    </b>
                                    <b>
                                        <a data-toggle="tooltip" data-placement="top" title="Edit Record" href="{{ route('questions.edit', $value->id) }}" class="btn btn-outline-info">
                                    ...
                                    <b>
                                        ...
                                        <form id="delete-form-{{ $key + 1 }}" action="{{ route('questions.destroy', $value->id) }}" method="POST" class="d-none">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </b>
