...
@section('css')
@php config(['app.name' => 'Blog | Question/Add']); @endphp
<!-- Tags -->
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="">
                        <form action="{{ route('questions.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="{{old('meta_title')}}" class="form-control @error('meta_title') is-invalid @enderror getMetaTitle" name="meta_title" id="meta_title" placeholder="Enter Meta Question Title">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" value="{{old('meta_description')}}" class="form-control @error('meta_description') is-invalid @enderror" name="meta_description" id="meta_description" placeholder="Enter Meta Question Description">
